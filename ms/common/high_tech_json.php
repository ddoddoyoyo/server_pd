<?php
	...
	//백분율
	//Total
	$sql = "SELECT COUNT(*) AS CNT FROM HD_PD_CHOICE_INFO WHERE PD_GUBUN = 3 AND LMS_LANGUAGE = :LMS_LANGUAGE";
	...
	//1번
	$sql = "SELECT COUNT(*) AS CNT FROM HD_PD_CHOICE_INFO WHERE PD_GUBUN = 3 AND PD_CHOICE = 1 AND LMS_LANGUAGE = :LMS_LANGUAGE";
	$stmt = $dbh->prepare($sql);
	$stmt->bindParam(':LMS_LANGUAGE',$LMS_LANGUAGE);
	$stmt->execute();
	...
	//2번
	$sql = "SELECT COUNT(*) AS CNT FROM HD_PD_CHOICE_INFO WHERE PD_GUBUN = 3 AND PD_CHOICE = 2 AND LMS_LANGUAGE = :LMS_LANGUAGE";
	$stmt = $dbh->prepare($sql);
	$stmt->bindParam(':LMS_LANGUAGE',$LMS_LANGUAGE);
	$stmt->execute();
	...
	//3번
	$sql = "SELECT COUNT(*) AS CNT FROM HD_PD_CHOICE_INFO WHERE PD_GUBUN = 3 AND PD_CHOICE = 3 AND LMS_LANGUAGE = :LMS_LANGUAGE";
	$stmt = $dbh->prepare($sql);
	$stmt->bindParam(':LMS_LANGUAGE',$LMS_LANGUAGE);
	$stmt->execute();
	...
	//4번
	$sql = "SELECT COUNT(*) AS CNT FROM HD_PD_CHOICE_INFO WHERE PD_GUBUN = 3 AND PD_CHOICE = 4 AND LMS_LANGUAGE = :LMS_LANGUAGE";
	$stmt = $dbh->prepare($sql);
	$stmt->bindParam(':LMS_LANGUAGE',$LMS_LANGUAGE);
	$stmt->execute();
	...
	//5번
	$sql = "SELECT COUNT(*) AS CNT FROM HD_PD_CHOICE_INFO WHERE PD_GUBUN = 3 AND PD_CHOICE = 5 AND LMS_LANGUAGE = :LMS_LANGUAGE";
	$stmt = $dbh->prepare($sql);
	$stmt->bindParam(':LMS_LANGUAGE',$LMS_LANGUAGE);
	$stmt->execute();
