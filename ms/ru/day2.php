	...
	<section data-role="page" id="page60" class="container ru">
		...
		<div data-role="main" class="ui-content">
			<div class="textwrap">
				...
				<div class="text">	
					<div id="textbox1" class="textbox">
						<p>В моей машине установлен двигатель 1.6 Turbo-GDI. Знали ли вы, что этот двигатель мощнее двигателя 1.8 Turbo автомобиля Golf?</p>
					</div>
				</div>
		...
		<div data-role="main" class="ui-content">
			...
			<div class="popLayer">
				...
				<div class="textwrap">
					...
					<div class="text">
						<div id="textbox1" class="textbox">
							<p>Установленный в i30 двигатель Gamma 1.6 Turbo-GDI отличается более высокой мощностью и крутящим моментом в сравнении с двигателем 1.8 Turbo у Golf. К сожалению, мало кто знает об этом.</p>
						</div>	
					</div>
				</div>	
			</div>
		...
		<div data-role="main" class="ui-content">
			<div class="textwrap">
				...
				<div class="text">	
					...
					<div id="textbox2" class="textbox">
						<p>Чувствуется, как работает DCT при переключении передач. По-настоящему оценить это можно на извилистой дороге.</p>
					</div>
					<div class="btn_box">
						<a href="#" id="go_next1" class="text_btn_l">
							<img src="../images/button/btn_next_talk_arrow_2.png" alt="next button">
	...
	<section data-role="page" id="page64" class="container ru">
		...
		<div data-role="main" class="ui-content">
			<div class="textwrap">
				...
				<div class="text">	
					<div id="textbox1" class="textbox">
						<p>При прохождении такого крутого поворота, как здесь, самое важное – это сцепление задней подвески с дорогой.</p>
					</div>
					<div id="textbox2" class="textbox">
						<p>Смотрите, при движении на средней скорости автомобиль не заносит.</p>
					</div>
					<div class="btn_box">
						<a href="#" id="go_next1" class="text_btn_l">
							<img src="../images/button/btn_next_talk_arrow_2.png" alt="next button">
	...
	<section data-role="page" id="page65" class="container">
		...
		<div data-role="main" class="ui-content">
			...
			<div class="textwrap">
				...
				<div class="text">
					<div id="textbox1" class="textbox">
						<p>Вы помните о многорычажной подвеске, которая обеспечивала устойчивость автомобиля на миланских дорогах?<br>Многорычажная подвеска также повышает сцепление задних колес с дорогой при прохождении крутых поворотов на высокой скорости.</p>
					</div>	
					<div id="textbox2" class="textbox">
		...
		<div data-role="main" class="ui-content">
			...
			<div class="popLayer">
				...
				<div class="textwrap">
					...
					<div class="text">
						<div id="textbox1" class="textbox">
							<p>Для улучшения жесткости в конструкции кузова используются конструкционные клеевые соединения, общая длина которых, насколько я знаю, составляет 112 метров, если вытянуть их в одну линию.</p>
						</div>	
					</div>
				</div>	
			</div>
	...
	<section data-role="page" id="page68" class="container">
		...
		<div data-role="main" class="ui-content">
			<div class="textwrap">
				<div class="text">	
					<div id="textbox1" class="textbox">
						<p>Ага! Вот почему я так хорошо чувствую автомобиль, проходя многочисленные повороты на высокой скорости. Такие ощущения... Мне нравится!!</p>
					</div>
				</div>
				<div class="text_tip">
					<img src="../images/button/tail_3_@3x.png" alt="text box">
	...
	<section data-role="page" id="page69" class="container">
		...
		<div data-role="main" class="ui-content">
			<div class="textwrap">
				<div class="text">	
					<div id="textbox1" class="textbox">
						<p>Давайте сделаем здесь остановку.</p>
					</div>
				</div>
				<div class="text_tip">
					<img src="../images/button/tail_3_@3x.png" alt="text box">
	...
	<div data-role="header" class="header">
		...
		<div data-role="main" class="ui-content">
			<div class="textwrap">
				...
				<div class="text">	
					<div id="textbox1" class="textbox">
						<p>Знаете ли вы, чем прославилась на весь мир извилистая дорога перевала Стельвио? Она соединяет между собой разные горы в Альпах, и отсюда открывается потрясающий вид.</p>
					</div>
					<div id="textbox2" class="textbox">
						<p>Посмотрите на дорогу, по которой мы только что проехали.<br>Головокружительно, не так ли? Сколько крутых поворотов осталось позади…<br>Это было здорово.</p>
					</div>
					<div id="textbox3" class="textbox">
						<p>Мощный двигатель 7-ступенчатая коробка передач с двойным сцеплением Высокая жесткость кузова Многорычажная задняя подвеска</p>
					</div>
					<div id="textbox4" class="textbox">
						<p>Благодаря всем этим характеристикам, управлять i30 – одно удовольствие!</p>
					</div>
					<div class="btn_box">
						<a href="#" id="go_next1" class="text_btn_l">
							<img src="../images/button/btn_next_talk_arrow_2.png" alt="next button">
	...
	<section data-role="page" id="page71" class="container">
		...
		<div data-role="main" class="ui-content">
			<div class="textwrap">
				<div class="text">	
					<div id="textbox1" class="textbox">
						<p>Ну, как?<br>Было страшно?<br>Надеюсь, вам понравилась езда по этой прекрасной извилистой дороге.<br>Мне – определенно да.</p>
					</div>
				</div>
				<div class="text_tip">
					<img src="../images/button/tail_3_@3x.png" alt="text box">
	...
	<section data-role="page" id="page73" class="container">
		...
		<div data-role="main" class="ui-content">
			<div class="textwrap">
				<div class="text">	
					<div id="textbox1" class="textbox">
						<p>Это место называется Fischers Fritz и находится оно в швейцарском Цюрихе.<br>Кликните на Цюриха.</p>
					</div>
					<!-- <div id="textbox2" class="textbox">
	...
	<div data-role="header" class="header">
		...
		<div data-role="main" class="ui-content">
			<div class="textwrap">
				...
				<div class="text">		
					<div id="textbox1" class="textbox">
						<p>Прежде чем отправиться на экскурсию по центру, давайте доедем до кемпинга и оставим наши вещи.</p>
					</div>
				</div>
			</div>
		...
		<div data-role="main" class="ui-content">
			<div class="textwrap">
				<div class="text">
					...
					<div id="textbox1" class="textbox">
						<p>Подождите секундочку, мне нужно сначала подключить телефон. Где же он?</p>
					</div>		
				</div>
			</div>
	...
	<section data-role="page" id="page86" class="container">
		...
		<div data-role="main" class="ui-content">
			...
			<div class="textwrap">
				...
				<div class="text">	
					<p>Система Android Auto в i30 позволяет пользоваться мобильными службами, дистанционным управлением, навигационной системой с голосовыми подсказками, а также совершать телефонные звонки и выходить в интернет.<br>Поддерживается большинство функций смартфона.</p>
				</div>
			</div>
	...
	<section data-role="page" id="page88" class="container">
		...
		<div data-role="main" class="ui-content">
			...
			<div class="textwrap">
				...
				<div class="text">	
					<p>i30 поддерживает систему Apple Car Play, которая после несложной процедуры синхронизации, позволяет пользоваться навигационной системой, совершать звонки и воспроизводить музыку.</p>
				</div>
			</div>
			<a href="#page89" id="go_page89" class="next_p_btn ui-btn go-next">
				<img src="../images/button/btn_next_02_@3x.png" alt="next button">
	...
	<section data-role="page" id="page95" class="container">
		...
		<div data-role="main" class="ui-content">
			<div class="textwrap">
				...
				<div class="text">	
					<div id="textbox1" class="textbox">
						<p>Позвольте в этот прекрасный вечер спеть песню.</p>
					</div>
				</div>
			</div>
