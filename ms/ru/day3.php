				...
				<section data-role="page" id="page2" class="container ru">
					...
					<div data-role="main" class="ui-content">
						<div class="textwrap">
							<div class="text">
								<div id="textbox1" class="textbox">
									<p>Даже при движении на высокой скорости i30 сохраняет управляемость без увеличения расхода топлива.<br>Слышал, что это стало возможным благодаря улучшению аэродинамических качеств.</p>
								</div>
							</div>
							<div class="text_tip">
								<img src="../images/button/tail_3_@3x.png" alt="text box">
						...
						<div class="textwrap">
							...
							<div class="text">
								<div id="textbox3_1" class="textbox">
									<p>Задний спойлер с боковыми декоративными элементами способствует созданию оптимальных воздушных потоков при движении.</p>
								</div>
								...
								<div id="textbox3_4" class="textbox">
									<p>Кстати, знаете ли вы, какой коэффициент аэродинамического сопротивления у i30?</p>
								</div>
								<div class="btn_box">
									<a href="#" id="go_next1" class="text_btn_l">
										<img src="../images/button/btn_next_talk_arrow_2.png" alt="next button">
				...
				<section data-role="page" id="page6" class="container">
					...
					<div data-role="main" class="ui-content">
						...
						<div class="titlewrap">
							<div class="text_i">
								<div id="textbox1">
									<p>Количество выступающих элементов корпуса сведено к минимуму</p>
								</div>	
							</div>
						</div>
						<div class="toggle">
						...
						<div class="textwrap">
							...
							<div class="text">
								<div id="textbox6_1" class="textbox">
									<p>Все благодаря высоким аэродинамическим характеристикам и уменьшению количества выступающих элементов корпуса на 30%.</p>
								</div>
						...
						<div class="textwrap">
							<div class="text">
								<div id="textbox8_1" class="textbox">
									<p>Вы знаете что-нибудь о том, какие двигатели устанавливаются в i30? Из 3 вариантов двигателей я выбрал Gamma 1.6 Turbo-GDI.</p>
								</div>
							</div>
							<div class="text_tip">
								<img src="../images/button/tail_3_@3x.png" alt="text box">
						...
						<div class="textwrap">
							<div class="text">
								<div id="textbox14_1" class="textbox">
									<p>Спортивный внешний вид и просторный салон. Это все про i30, не так ли? Он намного просторнее, чем любой его конкурент.</p>
								</div>
							</div>
							<div class="text_tip"><img src="../images/button/tail_3_@3x.png" alt="text box">
							</div>
						...
						<div class="textwrap">
							<div class="text">
								<div id="textbox15_1" class="textbox">
									<p>Может быть, поэтому этот автомобиль показался мне более просторным, чем любой из тех, за рулем которых мне приходилось ездить.</p>
								</div>
							</div>
							<div class="text_tip"><img src="../images/button/tail_3_@3x.png" alt="text box">
							</div>
						...
						<div class="textwrap">
							<div class="text">
								<div id="textbox17_1" class="textbox">
									<p>Эта часовая башня — одна из достопримечательностей Берна.</p>
								</div>
							</div>
							<div class="text_tip">
								<img src="../images/button/tail_3_@3x.png" alt="text box">
						...
						<div class="textwrap">
							...
							<div class="text">
								<div id="textbox18_1" class="textbox">
									<p>Название города можно перевести как «город медведей». Историческая часть Берна внесена в список объектов Всемирного наследия ЮНЕСКО.</p>
								</div>
								<div id="textbox18_2" class="textbox">
									<p>Здесь сохранились исторические памятники, создающие атмосферу средневековья.</p>
								</div>
					...
					<div data-role="main" class="ui-content">
						<div class="textwrap">
							<div class="text">
								...
								<div id="textbox0_2" class="textbox">
									<p>со множеством каналов является центром дорожной культуры с тихой атмосферой.<br>Поедемте же быстрее!</p>
								</div>
								<div class="btn_box">
									<a href="#" id="go_next1" class="text_btn_l">
										<img src="../images/button/btn_next_talk_arrow_2.png" alt="next button">
						...
						<div class="textwrap">
							...
							<div class="text">
								<div id="textbox23_1" class="textbox">
									<p>Когда открываешь панорамный люк, ощущение, что находишься в замкнутом пространстве, пропадает. Прямо как в кабриолете.</p>
								</div>
							</div>
						</div>
				...
				<section data-role="page" id="page26" class="container">
					...
					<div data-role="main" class="ui-content">
						<div class="textwrap">
							<div class="text">
								<div id="textbox1" class="textbox">
									<p>Это конечный пункт нашего путешествия — Страсбург.<br>расположенный на западном берегу Рейна. В городе Страсбурге хорошо развита система каналов.</p>
								</div>
								<div id="textbox2" class="textbox">
									<p>Здесь можно увидеть множество красивых небольших французских домиков.</p>
								</div>
								<div class="btn_box">
									<a href="#" id="go_next1" class="text_btn_l">
										<img src="../images/button/btn_next_talk_arrow_2.png" alt="next button">
						...
						<div class="textwrap">
							...
							<div class="text">
								<div id="textbox32_1" class="textbox">
									<p>Система удержания автомобиля на полосе движения (LKAS) — это высокотехнологичная система, предотвращающая отклонение автомобиля от полосы движения. Фронтальная камера распознает дорожную разметку, а система корректирует направление движения автомобиля при помощи MDPS.</p>
								</div>
							</div>
						</div>
						...
						<div class="textwrap">
							<div class="text">
								<div id="textbox33_1" class="textbox">
									<p>С системой LKAS удерживать автомобиль внутри полосы – проще простого.</p>
								</div>
							</div>
							<div class="text_tip"><img src="../images/button/tail_3_@3x.png" alt="text box">
							</div>
						...
						<div class="textwrap">
							...
							<div class="text">
								<div id="textbox34_1" class="textbox">
									<p>При помощи радара, установленного на заднем бампере, система мониторинга мертвых зон (BSD) отслеживает автомобили, приближающиеся к слепой зоне, и издает предупреждающий звуковой сигнал при возникновении риска столкновения.</p>
								</div>
							</div>
						</div>
						...
						<div class="textwrap">
							<div class="text">
								<div id="textbox35_1" class="textbox">
									<p>С системой BSD перестроение, как и контроль за мёртвыми зонами, становится намного безопаснее.</p>
								</div>
							</div>
							<div class="text_tip"><img src="../images/button/tail_3_@3x.png" alt="text box">
							</div>
						...
						<div class="textwrap">
							...
							<div class="text">
								<div id="textbox36_1" class="textbox">
									<p>Основываясь на траектории движения автомобиля и его положения относительно разметки, система контроля за вниманием водителя (DAA) следит за состоянием водителя.</p>
								</div>
								<div id="textbox36_2" class="textbox">
									<p>Если водитель устал и концентрация его внимания снизилась, на панели приборов появляется предупреждающее сообщение, рекомендующее водителю отдохнуть.</p>
								</div>	
