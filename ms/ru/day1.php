...
<html lang="en">
			...
			<div id="contBox" class="container">
					...
					<div data-role="main" class="ui-content">
						<div class="textwrap">
							<div class="text">	
								...
								<p>Я Джеймс!<br><span class="pointColor">Наконец то, я получил i30, который так ждал!</span><br>Теперь мы можем отправиться в запланированную поездку. <br>Садитесь в машину!</p>
							</div>
					...
					<div data-role="main" class="ui-content">
						<a href="#page3001" id="go_page3001"  class="next_p_btn layer_landscape">
							<div class="box">
								...
								<p>Поверните устройство для изменения ориентации экрана.</p>
								<p class="ok_btn">OK</p>
							</div>
						</a>
					</div>
						...
						<div class="textwrap">
							...
							<div class="text">
								<div id="textbox1" class="textbox">
									<p>Прежде чем мы отправимся в поездку, позвольте мне показать вам этот ролик, именно после него я решил купить i30.</p>
								</div>
							</div>
						</div>
						<div class="btn_play">
				...
				<section data-role="page" id="page5" class="container">
					...
					<div data-role="main" class="ui-content">	
						<div class="textwrap">	
							<div class="text">	
								<div id="textbox1" class="textbox">
									<p>Мы начнем наше путешествие в Милане, сделаем остановку у озера Комо и на перевале Стельвио, а затем доедем до Швейцарии.</p>
								</div>
								<div id="textbox2" class="textbox">
									<p>В Швейцарии мы посетим Цюрих и Берн, а затем отправимся в Страсбург – наш конечный пункт.</p>
								</div>
								<div class="btn_box">
				...
				<section data-role="page" id="page6" class="container">
					...
					<div data-role="main" class="ui-content">
						<div class="textwrap">
							<div class="text">	
								<div id="textbox1" class="textbox">
									<p>Наше путешествие начинается в Милане. Захватывающее начало, правда?</p>
								</div>
								<!-- <div id="textbox2" class="textbox">
				...
				<section data-role="page" id="page9" class="container">
					...
					<div data-role="main" class="ui-content">
						...
						<div class="textwrap">
							...
							<div class="text">	
								<p>Здесь будет наша первая остановка!<br>Я не мог не посетить Миланский собор с его утонченной красотой. Он является символом Милана.</p>
							</div>
						</div>
				...
				<section data-role="page" id="page11" class="container">
					...
					<div data-role="main" class="ui-content">
						<div class="textwrap">
							...
							<div class="text">
								<div id="textbox1" class="textbox">
									<p>В Италии все дороги узкие и вымощены камнем.</p>
								</div>
							</div>
					</div>
				...
				<section data-role="page" id="page12" class="container">
					...
					<div data-role="main" class="ui-content ui-content">
						<div class="textwrap">
							...
							<div class="text">	
								<div id="textbox1" class="textbox">
									<p>Несмотря на то, что мы едем по неровной дороге, мне комфортно находиться в машине.<br>Я слышал, что жесткость кузова i30 была увеличена. По моим ощущениям, это устойчивый автомобиль.</p>
								</div>
								<div id="textbox2" class="textbox">
									<p>Я в этом точно уверен, ведь я еду по дорогам е без покрытия!</p>
								</div>
								<div class="btn_box">
									<a href="#" id="go_next1" class="text_btn_l">
										<img src="../images/button/btn_next_talk_arrow_2.png" alt="next button">
				...
				<section data-role="page" id="page13" class="container ru">
					...
					<div data-role="main" class="ui-content">
						...
						<div class="textwrap">
							<div class="text_i">
								<div id="textbox1" class="textbox">
									<p>Давайте рассмотрим AHSS<br>(высокопрочная сталь)</p>
								</div>	
							</div>
						</div>
						...
						<div class="textwrap">
							<div class="text">	
								<div id="textbox1" class="textbox">
									...
									<p>В новом i30 применяется высокопрочная сталь для повышения жесткости кузовной рамы. Содержание высокопрочной стали составляет<span>?</span>Для сравнения, в предыдущей модели этот показатель был равен 27,2%.</p>
								</div>	
								<div id="textbox2" class="textbox">
									<p>Какой вариант правильный?</p>
									<ul class="btn_num">
				...
				<section data-role="page" id="page15" class="container">
					...
					<div data-role="main" class="ui-content">
						...
						<div class="textwrap">
							...
							<div class="text">	
								<p>Содержание высокопрочной стали в кузовной раме увеличилось до 53,5%.</p>
							</div>
						</div>
				...
				<section data-role="page" id="page16" class="container">
					...
					<div data-role="main" class="ui-content">
						<div class="textwrap">
							...
							<div class="text">	
								<div id="textbox1" class="textbox">
									<p>Теперь понятно почему автомобиль такой комфортный и устойчивый.<br>О, вы работаете в Hyundai, да?</p>
								</div>
								<div id="textbox2" class="textbox">
									<p>Вы знаете много интересного. Надеюсь, что во времени поездки я узнаю много новой информации.</p>
								</div>
								<div class="btn_box">
									<a href="#" id="go_next1" class="text_btn_l">
										<img src="../images/button/btn_next_talk_arrow_2.png" alt="next button">
				...
				<div data-role="header" class="header">
					...
					<div data-role="main" class="ui-content">
						<div class="textwrap">
							...
							<div class="text">	
								<div id="textbox1" class="textbox">
									<p>Миланский собор – это одно из «1001 зданий, которое обязательно нужно посетить хотя бы раз в жизни».</p>
								</div>
								<div id="textbox2" class="textbox">
				...
				<section data-role="page" id="page20" class="container">
					...
					<div data-role="main" class="ui-content">
						<div class="textwrap">
							<div class="text">	
								<div id="textbox1" class="textbox">
									<p>Вы заметили, как много в городе узких неровных дорог.<br>Может, это из-за городских трамваев?</p>
								</div>
							</div>
							<div class="text_tip">
								<img src="../images/button/tail_3_@3x.png" alt="text box">
				...
				<section data-role="page" id="page21" class="container ru">
					...
					<div data-role="main" class="ui-content">
						<div class="textwrap">
							...
							<div class="text">	
								<div id="textbox1" class="textbox">
									<p>Этот компактный хэтчбек прекрасно подходит для перемещения по городу. Чувствуется, как задняя подвеска амортизирует вибрации, возникающие при движении по ухабистой дороге.</p>
								</div>
							</div>
						</div>
				...
				<section data-role="page" id="page22" class="container">
					...
					<div data-role="main" class="ui-content">
						...
						<div class="textwrap">
							...
							<div class="text">
								<div id="textbox1" class="textbox">
									<p>Знаете ли вы, что многорычажная подвеска обычно устанавливается в спортивные автомобили для обеспечения более надежного сцепления с дорогой?</p>
								</div>	
								<div id="textbox2" class="textbox">
									<p>В конструкцию подвески i30 входит 5 рычагов, которые обеспечивают стабильное сцепление с дорогой любого типа.</p>
								</div>
								<div id="textbox3" class="textbox">
				...
				<div data-role="header" class="header">
					...
					<div data-role="main" class="ui-content">
						<div class="textwrap">
							...
							<div class="text">		
								<div id="textbox1" class="textbox">
									<p>А вы знали, что в работе над интерьером замка Сфорца принимали участие Леонардо да Винчи и Браманте?</p>
								</div>
								<div id="textbox2" class="textbox">
									<p>Это типичный пример архитектуры Ренессанса XV века.</p>
								</div>
								<div id="textbox3" class="textbox">
									<p>Замок был построен Франческо Сфорца.</p>
								</div>
				...
				<section data-role="page" id="page27" class="container">
					...
					<div data-role="main" class="ui-content">	
						<div class="textwrap">	
							<div class="text">	
								<div id="textbox1" class="textbox">
									<p>Это огромное строение хорошо сохранилось. Мне здесь нравится.</p>
								</div>							
							</div>
							<div class="text_tip"><img src="../images/button/tail_3_@3x.png" alt="text box">
							</div>
				...
				<section data-role="page" id="page28" class="container">
					...
					<div data-role="main" class="ui-content">
						...
						<div class="textwrap">
							<div class="text">	
								<p>Великолепная архитектура захватывает. Классный дизайн i30 также обращает на себя внимание.</p>
							</div>
							<div class="text_tip">
								<img src="../images/button/tail_3_@3x.png" alt="text box">
							</div>
				...
				<section data-role="page" id="page30" class="container">
					...
					<div data-role="main" class="ui-content">
						...
						<div class="textwrap">
							...
							<div class="text">
								<div id="textbox1" class="textbox">
									<p>Каскадная решетка радиатора подчеркивает спортивный образ. Камера, используемая в работе интеллектуальных систем безопасности, встроена в эмблему.</p>
								</div>	
								<div id="textbox2" class="textbox">
									<p>Мне очень нравится обрамление решетки радиатора - очень изящная деталь.</p>
								</div>
								<div class="btn_box">
									<a href="#" id="go_next1" class="text_btn_l">
										<img src="../images/button/btn_next_talk_arrow_2.png" alt="next button">
				...
				<section data-role="page" id="page32" class="container">
					...
					<div data-role="main" class="ui-content">
						<div class="textwrap">
							<div class="text_i">
								<div id="textbox1" class="textbox">
									<p>Проведите линию характера i30.</p>
								</div>	
							</div>
						</div>
						<div class="imgwrap">
				...
				<section data-role="page" id="page33" class="container">
					...
					<div data-role="main" class="ui-content">
						...
						<div class="textwrap">
							...
							<div class="text">
								<div id="textbox1" class="textbox">
									<p>Это небольшой, но очень элегантный автомобиль! Удлиненный капот и линия характера, тянущаяся вдоль боковой части кузова, визуально вытягивают корпус.</p>
								</div>
							</div>
						</div>
				...
				<section data-role="page" id="page35" class="container">
					...
					<div data-role="main" class="ui-content">
						...
						<div class="textwrap">
							...
							<div class="text">
								<div id="textbox1" class="textbox">
									<p>На спойлере установлен светодиодный стоп-сигнал. Сдвоенный патрубок глушителя - уникальная деталь, которая отсутствует во многих других автомобилях. На мой вкус, дизайн этой машины гораздо лучше, чем у Golf.</p>
								</div>
							</div>
						</div>
					...
					<div data-role="main" class="ui-content">
						<div class="textwrap">
							<div class="text">
								...
								<div id="textbox1" class="textbox">
									<p>На улице темнеет. Я слышал, что у i30 полностью светодиодные фары, которые отлично освещают дорогу перед автомобилем.</p>
								</div>		
							</div>
						</div>
				...
				<section data-role="page" id="page47" class="container">
					...
					<div data-role="main" class="ui-content">
						...
						<div class="textwrap">
							...
							<div class="text">
								<div id="textbox1" class="textbox">
									<p><strong>Strong Red</strong> хорошо контрастирует с кожаным салоном черного цвета.</p>
								</div>	
								<div id="textbox2" class="textbox">
									<p><strong>Черные</strong> материалы отделки придают салону роскошный вид.</p>
								</div>
								<div id="textbox3" class="textbox">
									<p>Декоративные элементы из кожи цвета <strong>Grey</strong> выполнены в минималистическом стиле.</p>
								</div>
								<div id="textbox4" class="textbox">
									<p><strong>Цвет Indigo blue</strong> ассоциируется с молодостью и весельем.</p>
								</div>
								<div id="textbox5" class="textbox">
									<p>Цвет <strong>Glam burgundy</strong> добавляет интерьеру элегантности.</p>
								</div>
								<div class="btn_box">
									<a href="#" id="go_next1" class="text_btn_l">
										<img src="../images/button/btn_next_talk_arrow_2.png" alt="next button">
				...
				<section data-role="page" id="page48" class="container">
					...
					<div data-role="main" class="ui-content">
						<div class="textwrap">
							<div class="text_i">
								<div id="textbox1" class="textbox">
									<p>Выберите цвет салона, который понравился вам больше всего.</p>
								</div>	
							</div>
						</div>
					...
					<div data-role="main" class="ui-content">
						<div class="textwrap">
							<div class="text">
								...
								<div id="textbox1" class="textbox">
									<p>Мне нравится интерьер со спортивными вставками красного цвета, которые обычно встречаются в спорткарах.</p>
								</div>		
								 <div id="textbox2" class="textbox">
									<p>Я предпочитаю роскошный интерьер, выполненный в черном цвете.</p>
								</div>
								<div id="textbox3" class="textbox">
									<p>Я бы выбрал салон в цвете Gray, так как этот цвет долго не надоедает.</p>
								</div>
								<div id="textbox4" class="textbox">
									<p>Я городской житель, мне нравится интерьер цвета indigo blue.</p>
								</div>
								<div id="textbox5" class="textbox">
									<p>Мне нравится бордовый интерьер, потому что цвет Glam burgundy лучше выражает индивидуальность.</p>
								</div> 
							</div>
						</div>
					...
					<div data-role="main" class="ui-content">
						...
						<div class="imgwrap">	
							<ul>
								...
								<li><span class="g_title">GLAM BURGUNGY </span><span class="g_num" id="burgundy">10</span></li>
							</ul>
						</div>
					</div>
				...
				<section data-role="page" id="page5001" class="container">
					...
					<div data-role="main" class="ui-content">	
						<div class="textwrap">	
							<div class="text">	
								<div id="textbox1" class="textbox">
									<p>Кто бы что ни говорил, а мой любимый – красный. Целую неделю не мог выбрать.</p>
								</div>
							</div>
							<div class="text_tip"><img src="../images/button/tail_3_@3x.png" alt="text box">
							</div>
				...
				<section data-role="page" id="page51" class="container">
					...
					<div data-role="main" class="ui-content">	
						<div class="textwrap">	
							<div class="text">	
								<div id="textbox1" class="textbox">
									<p>А сейчас давайте полюбуемся на озеро Комо, лучшее место отдыха в Италии.</p>
								</div>
							</div>
							<div class="text_tip"><img src="../images/button/tail_3_@3x.png" alt="text box">
							</div>
					...
					<div data-role="main" class="ui-content">
						<div class="textwrap">
							...
							<div class="text">	
								...
								<div id="textbox2" class="textbox">
									<p>Просто здесь очень красиво.</p>
								</div>
								<div id="textbox3" class="textbox">
	...
	<input type="hidden" id="LMS_LANGUAGE" name="LMS_LANGUAGE" value="ru">
	<!-- 여창민 대리 추가 (2017-03-30) : 끝 -->
