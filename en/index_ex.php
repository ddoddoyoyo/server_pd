...
<html>
	<head>
		...
		<script src="../js/g_action_ex.js"></script>
			...
			<div id="contBox" class="container">
				...
				<section data-role="page" id="page1001" class="container"> 
					<div data-role="main" class="ui-content">
						<div class="imgwrap">
							<div class="gif_img">
								<img src="/pc_pd/app/images/loading_short_4sec.gif" alt="">
							</div>
							<div class="loding_bar">
								<img src="/pc_pd/app/images/loading_bar_1.png" alt="" class="londing1">
								<img src="/pc_pd/app/images/loading_bar_2.png" alt="" class="londing2">
							</div>
						</div>
					</div>
				</section>
