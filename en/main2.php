...
<html>
	<head>
		...
		<script src="/pc_pd/app/js/g_action.js"></script>
		<script src="/pc_pd/app/js/menu.js"></script>
		<script src="/pc_pd/common/js/common.js"></script>
		<script>
	...
	<body>
			...
			<div id="contBox" class="container">
				...
				<section data-role="page" id="page43" class="container">
					...
					<div data-role="main" class="ui-content">
						...
						<a href="#page44"><div class="imgwrap">
							<img id="waking" src="../images/day1/icon_waking_1.png" alt="">
				...
				<section data-role="page" id="page48" class="container">
					...
					<div data-role="main" class="ui-content">
						...
						<?php
							$sql = "SELECT COUNT(*) AS COLOR_CNT FROM PD_CHOICE_INFO WHERE LMS_SEQ = :LMS_SEQ AND PD_GUBUN = 1";
					...
					<div data-role="main" class="ui-content">
						...
						<div class="imgwrap">	
							<ul>
								...
								<li><span class="g_title">BLACK</span><span class="g_num" id="black">15</span></li>
					...
					<div data-role="main" class="ui-content">
						...
						<div class="popLayer">
							...
							<div class="textwrap">
								...
								<div class="text">
									<div id="textbox1" class="textbox">
										<p>Except AHSS, the one we talked yesterday, the chassis of i30 used high strength metal adhesive to improve the body rigidity and durability.If I'm not wrong, metal adhesive is used 112M.</p>
									</div>	
								</div>
							</div>	
						</div>
				...
				<section data-role="page" id="page66" class="container">
					...
					<div data-role="main" class="ui-content">
						...
						<div class="textwrap">
							<div class="text_i">
								<div id="textbox1" class="textbox">
									<p>Extended application of structural adhesives </p>
								</div>	
							</div>
						</div>
						<div class="popLayer">
				...
				<section data-role="page" id="page69" class="container">
					...
					<div data-role="main" class="ui-content">
						<div class="textwrap">
							<div class="text">	
								<div id="textbox1" class="textbox">
									<p>Let's take a rest here, buddy.</p>
								</div>
							</div>
							<div class="text_tip">
								<img src="../images/button/tail_3_@3x.png" alt="text box">
					...
					<div data-role="main" class="ui-content">
						<div class="textwrap">
							...
							<div class="text">	
								...
								<div id="textbox3" class="textbox">
									<p>Noteworthy powerful engine,<br>7 Speed Dual Clutch Transmission,<br>Strong body rigidity,<br>Multilink rear-suspension system</p>
								</div>
								<div id="textbox4" class="textbox">
					...
					<div data-role="main" class="ui-content">
						<div class="imgwrap">
							...
							<div class="device_wrap">
								<a href="#page85" class="deviceL"><div ><img src="../images/day2/42_btn_right.png" alt=""></div></a>
								<a href="#page87" class="deviceR"><div><img src="../images/day2/42_btn_left.png" alt=""></div></a>
							</div>
						</div>
					</div>
				</section>
		...
		<!-- 여창민 대리 추가 (2017-03-30) : 시작 -->
		<input type="text" id="SESSION_LMS_SEQ" name="SESSION_LMS_SEQ" value="<?=$_SESSION["HY_LMS_SEQ"]?>">
		<!-- 여창민 대리 추가 (2017-03-30) : 끝 -->
	</body>
</html>